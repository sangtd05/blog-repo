---
title: "Monitoring - Hệ thống Thu thập và Giám sát Metrics"
datePublished: Wed Dec 31 2025 02:55:10 GMT+0000 (Coordinated Universal Time)
cuid: cmjtfb6y6000102l2b9pi7k4v
slug: monitoring-he-thong-thu-thap-va-giam-sat-metrics
cover: https://cdn.hashnode.com/res/hashnode/image/upload/v1767149582187/cf540ae4-5789-469d-93ac-eed57583601b.png
tags: devops
...
## **Kiến trúc Metrics trong Hệ thống**

![](https://cdn.hashnode.com/res/hashnode/image/upload/v1767149553019/2d85133f-3dc4-404f-b61b-1837cdd3772a.png align="center")
...
**Tại sao dùng file\_sd\_configs?**
...
sequenceDiagram
    ...
    participant T as Receivers (Telegram)

    P->>A: Alert: CPU > 90%
    P->>A: Alert: Memory > 80%

    Note over A: Group alerts<br/>(same cluster)
    Note over A: Wait 30s for more

    A->>T: Send grouped alert

    P->>A: Alert: CPU resolved
    A->>T: Send resolution
```
